...
insert into application_user (version, id, username,name,hashed_password,profile_picture) values (1, '2','admin','KevDawg','$2a$10$jpLNVNeA7Ar/ZQ2DKbKCm.MuT2ESe.Qop96jipKMq7RaUgCoQedV.','')
